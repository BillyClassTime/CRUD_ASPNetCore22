...
namespace Fourth_Coffee_Contact_Finder
{
    public class SalesDataLoader
    {
        ...
        {
            this._serviceUri = serviceUri ?? throw new NullReferenceException(nameof(serviceUri));
        }
        ...
        private void InitializeRequest()
        {
            ...
            if (this._request == null)
                throw new NullReferenceException(nameof(_request));
        }
        ...
        private async void GetData(WebResponse response)
        {
            ...
            var urlTextText = await streamReader.ReadToEndAsync(); 
            //var urlTextText = await streamReader.ReadLineAsync();
